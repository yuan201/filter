...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['chelinfeite.ddns.net'])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='Filter <noreply@chelinfeite.ddns.net>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Filter] ')
